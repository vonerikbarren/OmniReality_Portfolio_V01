...
- Is there a "default" or common value type objects/services get
  weighed against for practical trading, or is every pairwise exchange
  independently negotiated with no common reference at all?
...
Purely conceptual - a name and a shape, not a mechanic. No data model,
no exchange logic, no relationship to any other system (OmniPlayer,
OmniBrowserSpace stores, etc.) has been designed. Noted here so the
idea persists; real design work hasn't started.
